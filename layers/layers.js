...
lyr_SecoursPopulaire_7.set('fieldAliases', {'fid': 'fid', 'Nom': 'Nom', 'Adresse': 'Adresse', 'Commune': 'Commune', 'Full Addre': 'Full Addre', 'Latitude': 'Latitude', 'Longitude': 'Longitude', 'Site Inter': 'Site', });
lyr_CroixRouge_8.set('fieldAliases', {'fid': 'fid', 'Croix-Roug': 'Croix-Roug', 'Adresse': 'Adresse', 'Commune': 'Commune', 'Full Addre': 'Full Addre', 'Latitude': 'Latitude', 'Longitude': 'Longitude', });
...
lyr_SecoursPopulaire_7.set('fieldImages', {'fid': '', 'Nom': 'TextEdit', 'Adresse': 'TextEdit', 'Commune': 'Hidden', 'Full Addre': 'Hidden', 'Latitude': 'Hidden', 'Longitude': 'Hidden', 'Site Inter': 'TextEdit', });
lyr_CroixRouge_8.set('fieldImages', {'fid': '', 'Croix-Roug': '', 'Adresse': '', 'Commune': '', 'Full Addre': '', 'Latitude': '', 'Longitude': '', });
...
lyr_SecoursPopulaire_7.set('fieldLabels', {'fid': 'no label', 'Nom': 'no label', 'Adresse': 'header label - visible with data', 'Site Inter': 'header label - visible with data', });
lyr_CroixRouge_8.set('fieldLabels', {'fid': 'no label', 'Croix-Roug': 'no label', 'Adresse': 'header label - visible with data', 'Commune': 'hidden field', 'Full Addre': 'hidden field', 'Latitude': 'hidden field', 'Longitude': 'hidden field', });
